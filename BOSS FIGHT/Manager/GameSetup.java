...
public class GameSetup {
    ...
    private Character selectBoss() {
        ...
        GamePrinter.println("2. Joker  - Swift, can disappear, brandishes many knives and chaotic power");
        GamePrinter.printDivider();

        System.out.print("Choose boss: ");

        int bossChoice = InputUtil.readIntInRange(sc, 1, 3);
        ...
        if (bossChoice == 1) {
            ...
            return CharacterFactory.createJoker();
        }
    }
}